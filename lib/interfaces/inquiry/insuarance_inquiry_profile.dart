...
class InsuaranceInquiryProForm extends StatefulWidget {
  final bool isInquiryPending;
  final String inquiryType;
  final String bearerToken;

  const InsuaranceInquiryProForm({
    Key? key,
  ...
  @override
  _InsuaranceInquiryProFormState createState() => _InsuaranceInquiryProFormState();
}

class _InsuaranceInquiryProFormState extends State<InsuaranceInquiryProForm> {
