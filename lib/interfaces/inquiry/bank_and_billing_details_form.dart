// ignore_for_file: avoid_print, library_private_types_in_public_api, use_build_context_synchronously, unused_import, prefer_const_constructors, sort_child_properties_last
...
class BankBillingProofScreen extends StatefulWidget {
  final String bearerToken;
  final int inquiryId;
  final String inquiryType;
  final bool isCustomer;

  const BankBillingProofScreen({
    Key? key,
  ...
  @override
  _BankBillingProofScreenState createState() => _BankBillingProofScreenState();
}

class _BankBillingProofScreenState extends State<BankBillingProofScreen> {
  ...
  Future<void> _pickFile({required String fileType}) async {
    try {
      ...
      if (result != null && result.files.isNotEmpty) {
        ...
        _formKey.currentState?.validate();
        _showFlashMessage(
          '${fileType.replaceAll('_', ' ')} file selected: $fileName',
        );
      } else {
  ...
  void _saveData() async {
    ...
    try {
      ...
      if (_billingProofFile != null &&
          _billingProofFileName != null &&
          _selectedBillType != null) {
        final billingProofResponse = await _apiManager
            .uploadCustomerBillingProof(
              widget.bearerToken,
              _billingProofFile!,
