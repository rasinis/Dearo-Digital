...
//import 'package:dearo_app/interfaces/bank_and_billing_details_form.dart';
//import 'package:dearo_app/interfaces/bank_g1_form.dart';
//import 'package:dearo_app/interfaces/bank_g2_form.dart';
...
class ProccedBankG2 extends StatelessWidget {
  const ProccedBankG2({super.key});
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            Image.asset(
              'assets/upload_vehicle_image.jpg', 
              height: 200,
            ),
