...
import 'package:dearo_app/api/responses/response_guarantor_profile.dart';
...
class Guarantor2Form extends StatefulWidget {
  final String bearerToken;
  final int inquiryId;
  final String inquiryType;
  final bool isFirst;

  const Guarantor2Form({
    Key? key,
  ...
  @override
  _Guarantor2FormState createState() => _Guarantor2FormState();
}

class _Guarantor2FormState extends State<Guarantor2Form> {
  ...
  void _saveGuarantorDetails() async {
    ...
    try {
      ...
      if (guarantorResponse.error) {
        ...
        print(
          "Guarantor Profile Saved: ${guarantorResponse.guarantor_profile}",
        );
      }
                ...
                Container(
                  ...
                  child: Padding(
                    ...
                    child: DropdownMenu(
                      ...
                      dropdownMenuEntries:
                          DistrictManager.getDistricts().entries.map((entry) {
                            return DropdownMenuEntry(
                              value: District(
                                id: entry.key,
                                districtName: entry.value,
                              ),
                              label: entry.value,
                            );
                          }).toList(),
