...
class InvestmentInquiryProForm extends StatefulWidget {
  final bool isInquiryPending;
  final String inquiryType;
  final String bearerToken;

  const InvestmentInquiryProForm({
    Key? key,
  ...
  @override
  _InvestmentInquiryProFormState createState() =>
      _InvestmentInquiryProFormState();
}

class _InvestmentInquiryProFormState extends State<InvestmentInquiryProForm> {
        ...
        if (!responseProfileUpdate.error) {
          ...
          if (!response.error) {
            Navigator.of(context).pushAndRemoveUntil(
              MaterialPageRoute(
                builder:
                    (context) => InquiryManager.getNextFdScreen(
                      bearerToken: token,
  ...
  Widget buildNicUploadButton(bool isFront) {
    ...
    return ElevatedButton(
      ...
      style: ElevatedButton.styleFrom(
        backgroundColor: const Color(0xFFDEDFF2),
